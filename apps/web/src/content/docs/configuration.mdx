...
<Aside type="tip">
	You can omit fields you don't need. The template will simply not display them. However, the ability to generate outputs depends on the template
	you're using.
</Aside>
...
Open source contributions share the same structure as [Project Entry](#project-entry). They are shown in the Open Source section of your GitHub profile.
