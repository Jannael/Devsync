...
<Aside>
**GitHub Action**: The GitHub Action only includes Bun and Node.js setup. If your portfolio requires additional system dependencies to perform the `build`, you will need to install them within the GitHub Action.
</Aside>
...
<Aside type="tip">
For your personal portfolio, CI/CD is perfectly fine. This section is only for template creators who want to show a preview without coupling users to a specific host.
</Aside>
